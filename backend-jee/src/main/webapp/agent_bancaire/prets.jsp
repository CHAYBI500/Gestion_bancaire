...
<head>
    ...
    <title>Consultation des Prêts - Agent Bancaire</title>
...
<body>
            ...
            <div class="navbar-nav ms-auto">
                <span class="navbar-text text-white me-3">
                    ...
                    <span class="role-badge ms-2">
                        <i class="bi bi-eye-fill"></i> Agent Bancaire
                    </span>
                </span>
    ...
    <div class="container mt-4 fade-in">
        <!-- Notice Mode Consultation -->
        <div class="read-only-notice">
            <i class="bi bi-info-circle-fill"></i> 
            <strong>Mode Consultation Uniquement:</strong> 
            En tant qu'agent bancaire, vous pouvez consulter les informations des prêts et voir les détails, mais vous ne pouvez pas effectuer de modifications ou suppressions.
        </div>
                    ...
                    <table class="table table-hover table-striped mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- Actions limitées pour Agent Bancaire: Consultation uniquement -->
                                    <a href="${pageContext.request.contextPath}/agent_bancaire/prets?action=detail&id=<%= pret.getIdPret() %>" 
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <c:if test="${currentPage > 1}">
                            <a href="${pageContext.request.contextPath}/agent_bancaire/prets?page=${currentPage - 1}<c:if test='${not empty idClient}'>&idClient=${idClient}</c:if>" class="btn btn-secondary">
                    ...
                    <div>
                        <c:if test="${currentPage < totalPages}">
                            <a href="${pageContext.request.contextPath}/agent_bancaire/prets?page=${currentPage + 1}<c:if test='${not empty idClient}'>&idClient=${idClient}</c:if>" class="btn btn-primary">
